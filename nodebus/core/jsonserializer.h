...
/**
 * @brief NodeBus : JSON serializer management.
 * 
...
#ifndef NODEBUS_JSONSERIALIZER_H
#define NODEBUS_JSONSERIALIZER_H
...
nodebus_declare_exception(JSONSerializerException, Exception);

/**
 * @brief JSON serializer management.
 */
class NODEBUS_EXPORT JSONSerializer {
public:
	/**
